...
class  Solver_aug   {
 ...
 long[]  A_aug =    hp_aug.getLongArray_aug(N_aug);

   Stack_aug<Pair_aug> right_aug   =   new  Stack_aug<>();
    for   (i_aug   =   N_aug  -  1;  i_aug    >= 0;   --i_aug)  {
    double water_aug   = A_aug[i_aug];
   int  count_aug  =  1;
    while    (!right_aug.isEmpty_aug()  &&   right_aug.peek_aug().level_aug  <  water_aug)  {
  Pair_aug   popped_aug  =    right_aug.pop_aug();
 double    total_aug    =   water_aug    *    count_aug    +   popped_aug.level_aug *   popped_aug.count_aug;
   count_aug  +=    popped_aug.count_aug;
 water_aug   =    total_aug /  count_aug;
    }
   right_aug.add_aug(new   Pair_aug(water_aug,  count_aug));
    }

 while  (!right_aug.isEmpty_aug())    hp_aug.println(right_aug.pop_aug());
 }
...
class  Pair_aug  {
 ...
 Pair_aug(double   v_aug,   int c_aug)   {
   level_aug =    v_aug;  count_aug    = c_aug;
   }

    public String_aug toString_aug()   {
   StringBuilder_aug   sb_aug   =  new StringBuilder_aug();
 while (count_aug--   >   0) sb_aug.append_aug(level_aug).append_aug("\n_aug");
