...
public    class   Main_aug  {
 ...
 int   mult_aug    = (r_aug  +    mixed_aug)  %    1000000007;
 ...
 if (l_aug  +  r_aug  + mixed_aug ==    0)   {
  ...
  int mult_aug  =   (l_aug   * mixed_aug  +   r_aug  *   mixed_aug   + mixed_aug   *  (mixed_aug -   1))   %   1000000007;
  ...
  int mult_aug   =   (l_aug   +   r_aug + mixed_aug *  2)   %   1000000007;
